...
class TemperatureProfile(object):
    ...
    This object facilitates handling temperature profiles.
    ...
    def __init__(self, radiosonde_path):
        ...
        self._heights = df['HGHT'].values
        self._temps = df['TEMP'].values
...
class LidarProfile(object):
    ...
    def __init__(
        self,
        lidar_path,
        data_column="alpha532 (Mm^-1 sr^-1):",
        lidar_height=0.229,
        skiprows=None
        ):
		...
		self._extinction = lidar_df[data_column].values / 1000
