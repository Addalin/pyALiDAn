...
RAY_HYPER_PARAMS = {
    ...
    "use_power": tune.grid_search([' ([0.5,-0.265,1], [0.5])', '([0.5,-0.265,0.5], [0.5])']),
    # "([0.5, -0.11, 0.5], [0.5])"]),
    ...
    'dfilter': tune.grid_search([('wavelength', [532])]),  # ([None , ('wavelength', [355]), ('wavelength', [532]), ('wavelength', [1064])]),
