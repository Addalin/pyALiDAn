...
for type in ['red','black','green']:
	x_type,y_type,label_type, x_err,y_err = df_A_LR[df_A_LR['type']==type]['x'],	                                       df_A_LR[df_A_LR['type']==type]['y'],	                                       df_A_LR[df_A_LR['type']==type]['name'].unique()[0],	                                       df_A_LR[df_A_LR['type']==type]['dx']*.5,	                                       df_A_LR[df_A_LR['type']==type]['dy']*.5
